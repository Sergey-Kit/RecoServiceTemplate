...
4. Обернуть в сервис, который должен  критериям читаемости и воспоизводимости. (2 балла)

Autoencoder:

1. Значимо изменить архитектуру модели (2 балла)
2. Пробить скор бейзлайна DSSM модели 0.075. (2 балла)
3. Обернуть в сервис, который должен  критериям читаемости и воспоизводимости. (2 балла)
...
2. Пробить скор бейзлайна DSSM модели 0.075. (3 балла) - не доделал
3. Обернуть в сервис, который должен  критериям читаемости и воспоизводимости. (5 балла) - не доделал
