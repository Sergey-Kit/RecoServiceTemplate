...
1)  Побил метрику на лидерборде map@10 = 0.063 для userKnn модели

![image](https://github.com/Sergey-Kit/RecoServiceTemplate/assets/82327055/7a3d769f-3cf3-42e9-a79f-b7204b85dcb2)

2) Реализовал два первых эксперимента в ноутбуке (/notebooks/itmo_recsys_dz_3_kNN.ipynb) 

3) Реализовал оффлайн вариант инференса.
   Начал делать интеграцию в сервис. Накиньте баллов по-братски))
