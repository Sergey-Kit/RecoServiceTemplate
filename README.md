...
- Сравненил метрики двухэтапной модели и моделей первого уровня на тестовой выборке
...
Стать лучше себя вчерашнего - двухэтапная модель бьет все ваши прошлые посылки и отображается на основном лидерборде (2 балла)
